    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-folder"></i> MENU
          </h3>
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                ...
                >
                  <i class="fa fa-plus-circle"></i> TAMBAH MENU</nuxt-link
                >
              </div>
              <input
                type="text"
...
export default {
  ...
  head() {
    return {
      ...
      meta: [
        ...
        { name: "keywords", content: "Halaman Menu, Menu" },
      ],
    };
  },
  ...
  async asyncData({ $axios, query }) {
    ...
    const menu = await $axios.$get(`/api/admin/menus?q=${search}&page=${page}`);
        ...
        .then((result) => {
          if (result.isConfirmed) {
            this.$axios
              ...
              .catch(() => {
                this.$swal.fire("Gagal!", "Menu gagal dihapus.", "error");
              });
          }
        });
    },
