    ...
    <section class="content">
      <section class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-tags"></i> TAMBAH POSTS
          </h3>
        ...
        <div class="card-body">
          <form @submit.prevent="storePosts">
  ...
  methods: {
    ...
    async storePosts() {
      try {
        ...
        formData.append("category_id", this.posts.category_id ? this.posts.category_id.id : "");
        ...
        const response = await this.$axios.post("/api/admin/posts", formData, {
          headers: {
        ...
        this.$swal.fire({
          title: "Berhasil",
          text: "Posts berhasil ditambahkan",
          icon: "success",
